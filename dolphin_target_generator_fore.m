function [Nodes_all,C_b,C_s,C_b_in,C_s_in,target] = dolphin_target_generator_fore(wing_string,theta,number,ratio)
...
[new_set,target_set ]= control_panel(ori,size_z,pi/180*theta,0,0.9);
