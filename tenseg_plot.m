function [fig_out] = tenseg_plot( N,C_b,C_s,fig_handle,highlight_nodes,view_vec )
...
if ~isempty(C_b),
	...
	quiver3(bar_start_nodes(1,:),bar_start_nodes(2,:),bar_start_nodes(3,:),B(1,:),B(2,:),B(3,:),'black.','Autoscale','off','LineWidth',0.5)
	hold on
end
