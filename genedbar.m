...
%     b=[b,n3,n4];
%     a=[n3;n4];
        nodes(4*(i-1)+1,:)=[p((i-1)*4+2,[1 2]) 0 4*(i-1)+1];
        nodes(4*(i-1)+2,:)=[p((i-1)*4+3,[3 4]) 0 4*(i-1)+2];
        nodes(4*(i-1)+3,:)=[p((i-1)*4+3,[1 2]) 0 4*(i-1)+3];
        nodes(4*(i-1)+4,:)=[p((i-1)*4+2,[3 4]) 0 4*(i-1)+4];
...
%     for i=1:b(count)
        ...
        C_s_in=[C_s_in;nodes(4*(i-1)+2,1:3) nodes(4*(i-1)+4,1:3)];
%     end
