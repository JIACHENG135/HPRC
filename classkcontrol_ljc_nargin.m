function dy = classkcontrol_ljc_nargin(t,x0,Inp,filename)
persistent gammashist
% persistent time_counter
persistent lambdahist
if nargin ==3
...
lambdahist(:,1)=zeros(size(Cb,1),1);
...
lambda_vec = -biglambda*gammas-tau;
lambdahist = [lambdahist lambda_vec];
