function [fig_out] = tenseg_plot_with_axis( N,C_b,C_s,fig_handle,highlight_nodes,view_vec,axis_vec )
...
% . axis_vec (optional): plotting axis limits
% Outputs:
...
if isempty(axis_vec),
	[axis_vec_derived, ~] = tenseg_axisview(N);
	axis_vec = axis_vec_derived;
end
view(view_vec)
axis(axis_vec)
hold off
